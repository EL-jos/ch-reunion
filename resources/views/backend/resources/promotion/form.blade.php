...
@section('main-content')
    <div class="card card-warning">
        ...
        <div class="card-body">
            <form action="{{ $promotion->exists ? route('promotion.update', $promotion) : route('promotion.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control is-valid" name="percent" id="percent" placeholder="Pourcentage ..." value="{{ $promotion->exists ? $promotion->percent : old('percent') }}">
                </div>
