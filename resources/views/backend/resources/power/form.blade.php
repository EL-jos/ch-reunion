...
@section('main-content')
    <div class="card card-warning">
        ...
        <div class="card-body">
            <form action="{{ $power->exists ? route('power.update', $power) : route('power.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method($power->exists ? 'PUT' : 'POST')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-valid" name="value" id="value" placeholder="Valeur ..." value="{{ $power->exists ? $power->value : old('value') }}">
                </div>
