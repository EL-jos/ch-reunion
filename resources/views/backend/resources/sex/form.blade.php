...
@section('main-content')
    <div class="card card-warning">
        ...
        <div class="card-body">
            <form action="{{ $sex->exists ? route('sex.update', $sex) : route('sex.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method($sex->exists ? 'PUT' : 'POST')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-valid" name="name" id="name" placeholder="Nom ..." value="{{ $sex->exists ? $sex->name : old('name') }}">
                </div>
