...
@section('main-content')
    <div class="card card-warning">
        ...
        <div class="card-body">
            <form action="{{ $dimension->exists ? route('dimension.update', $dimension) : route('dimension.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method($dimension->exists ? 'PUT' : 'POST')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-valid" name="value" id="value" placeholder="Valeur ..." value="{{ $dimension->exists ? $dimension->value : old('value') }}">
                </div>
