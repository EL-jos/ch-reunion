            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="el-btns-controls">
                        ...
                        <a href="{{ route('trashed.variant') }}" class="btn btn-block btn-primary">Supprimées</a>
                    </div>
                        ...
                        <tbody>
                            @foreach($variants as $variant)
                                <tr>
                                    ...
                                    <td>{{ $variant->article->name }}</td>
                                    <td>
                                        @foreach($variant->article->categories as $category)
                                            @if(($loop->index + 1) === $variant->article->categories->count())
                                                {{ $category->name . "." }}
                                            @else
                                                {{ $category->name . "; " }}
                                            @endif
