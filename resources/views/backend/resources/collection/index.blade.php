            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="el-btns-controls">
                        <a href="{{ route('collection.create') }}" class="btn btn-block btn-primary">Ajouter</a>
                        <a href="{{ route('collection.create') }}" class="btn btn-block btn-primary">Supprimées</a>
                    </div>
                        ...
                        <tbody>
                            @foreach($collections as $collection)
                                <tr>
                                    ...
                                    <td>{{ strtoupper($collection->brand->name) }}</td>
                                    <td>
                                        <div class="d-flex" style="gap: .5rem;">
                                            <a href="{{ route('collection.edit', $collection) }}" class="btn bg-gradient-warning"><i class="fas fa-edit"></i></a>
