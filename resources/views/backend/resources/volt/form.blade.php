...
@section('main-content')
    <div class="card card-warning">
        ...
        <div class="card-body">
            <form action="{{ $volt->exists ? route('volt.update', $volt) : route('volt.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method($volt->exists ? 'PUT' : 'POST')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-valid" name="value" id="value" placeholder="Valeur ..." value="{{ $volt->exists ? $volt->value : old('value') }}">
                </div>
