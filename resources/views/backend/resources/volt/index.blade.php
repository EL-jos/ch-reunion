            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="el-btns-controls">
                        <a href="{{ route('volt.create') }}" class="btn btn-block btn-primary">Ajouter</a>
                        <a href="{{ route('volt.create') }}" class="btn btn-block btn-primary">Supprimées</a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex" style="gap: .5rem;">
                                            <a href="{{ route('volt.edit', $volt) }}" class="btn bg-gradient-warning"><i class="fas fa-edit"></i></a>
