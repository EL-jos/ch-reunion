...
@section('main-content')
    <div class="card card-warning">
        ...
        <div class="card-body">
            <form action="{{ $temperature->exists ? route('temperature.update', $temperature) : route('temperature.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method($temperature->exists ? 'PUT' : 'POST')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-valid" name="value" id="value" placeholder="Valeur ..." value="{{ $temperature->exists ? $temperature->value : old('value') }}">
                </div>
